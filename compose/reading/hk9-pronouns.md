...
entirely on `g`, which the utterance context supplies. So *She smokes* (@ref) has the
...
Now consider *John blamed himself* (@cb). There are **two** LFs that yield the same
...
*Every woman blamed herself* (@cb) has **only** the binding LF, giving the bound
